...
angular.module('ui.harmonize.alert', [])
...
angular.module('ui.harmonize.buttons', [])
...
/**
* @ngdoc overview
* @name ui.harmonize.carousel
*
* @description
* AngularJS version of an image carousel.
*
*/
angular.module('ui.harmonize.carousel', [])
...
/**
 * @ngdoc directive
 * @name ui.harmonize.carousel.directive:carousel
 * @restrict EA
 *
 * @description
...
/**
 * @ngdoc directive
 * @name ui.harmonize.carousel.directive:slide
 * @restrict EA
 *
 * @description
 * Creates a slide inside a {@link ui.harmonize.carousel.directive:carousel carousel}.  Must be placed as a child of a carousel element.
 *
...
angular.module('ui.harmonize.dropdown', ['ui.harmonize.position'])
...
angular.module('ui.harmonize.pagination', [])
 ...
 */
angular.module( 'ui.harmonize.tooltip', [ 'ui.harmonize.position', 'ui.harmonize.bindHtml' ] )
...
.provider( '$tooltip', function () {
   ...
   * application.
   *
   *   var app = angular.module( 'App', ['ui.harmonize.tooltip'], function( $tooltipProvider ) {
 ...
 */
angular.module( 'ui.harmonize.popover', [ 'ui.harmonize.tooltip' ] )
...
angular.module('ui.harmonize.progressbar', [])
...
angular.module('ui.harmonize.rating', [])
...
/**
 * @ngdoc overview
 * @name ui.harmonize.tabs
 *
 * @description
 * AngularJS version of the tabs directive.
 */

angular.module('ui.harmonize.tabs', [])
...
/**
 * @ngdoc directive
 * @name ui.harmonize.tabs.directive:tabset
 * @restrict EA
 *
 * @description
...
/**
 * @ngdoc directive
 * @name ui.harmonize.tabs.directive:tab
 * @restrict EA
 *
 * @param {string=} heading The visible heading, or title, of the tab. Set HTML headings with {@link ui.harmonize.tabs.directive:tabHeading tabHeading}.
 * @param {string=} select An expression to evaluate when the tab is selected.
 * @param {boolean=} active A binding, telling whether or not this tab is selected.
 * @param {boolean=} disabled A binding, telling whether or not this tab is disabled.
 *
 * @description
 * Creates a tab with a heading and content. Must be placed within a {@link ui.harmonize.tabs.directive:tabset tabset}.
 *
 * @example
<example module="ui.harmonize">
  <file name="index.html">
...
/**
 * @ngdoc directive
 * @name ui.harmonize.tabs.directive:tabHeading
 * @restrict EA
 *
 * @description
 * Creates an HTML heading for a {@link ui.harmonize.tabs.directive:tab tab}. Must be placed as a child of a tab element.
 *
 * @example
<example module="ui.harmonize">
  <file name="index.html">
...
angular.module('ui.harmonize.transition', [])
  ...
  return {
    ...
    link:function (originalScope, element, attrs, modelCtrl) {
      ...
      popUpEl.attr({
        ...
        query: 'query',
        position: 'position',
        'assign-is-open': 'assignIsOpen(isOpen)'//added by Irene
      });
...
angular.module("template/rating/rating.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("template/rating/rating.html",
      "<div class=\"ratings\"><span ng-mouseleave=\"reset()\" ng-keydown=\"onKeydown($event)\" tabindex=\"0\" role=\"slider\" aria-valuemin=\"0\" aria-valuemax=\"{{range.length}}\" aria-valuenow=\"{{value}}\">\n" +
      "    <i ng-repeat=\"r in range track by $index\" ng-mouseenter=\"enter($index + 1)\" ng-click=\"rate($index + 1)\" class=\"p-icon ng-isolate-scope active\" ng-class=\"$index < value && (r.stateOn || 'glyphicon-star') || (r.stateOff || 'glyphicon-star-empty')\">\n" +
      "        <span class=\"sr-only\">({{ $index < value ? '*' : ' ' }})</span>\n" +
      "    </i>\n" +
      "</span></div>");
}]);
